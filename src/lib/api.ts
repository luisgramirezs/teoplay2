...
function buildPrompt(perfil: PerfilNino, escenaGramatical?: { url: string; descripcion: string } | null): string {
    ...
    const prompt = [
        ...
        `34b. Para asignatura matemáticas, física o química: si el objetivo de aprendizaje es PROCEDIMENTAL, DEBES generar "apoyoOperativo" con 1-2 "ejemplosResueltos" y un "ejercicio". "ejercicio.pasosGuia" es OBLIGATORIO, nunca vacío, y cada paso DEBE ser una explicación LARGA Y COMPLETA (3 a 5 oraciones, no 1), como un tutor humano sentado al lado del niño explicándole con calma. Cada paso debe: (1) nombrar la relación o el concepto matemático detrás del paso, (2) explicar por qué ese paso es necesario dentro del procedimiento completo, (3) decir con qué números exactos de "ejercicio.enunciado" trabajar, y (4) invitar al niño a hacerlo en su cuaderno — SIN dar el resultado. Ejemplo de la EXTENSIÓN Y PROFUNDIDAD mínima esperada por paso, para "si 7 manzanas cuestan 21 euros, ¿cuánto costarán 10 manzanas?": "Este problema es de regla de tres, que sirve para encontrar un valor desconocido cuando dos cantidades crecen de forma proporcional — si compras más manzanas, pagas más dinero, en la misma proporción. El primer paso es escribir esa relación conocida: 7 manzanas cuestan 21 euros. Escribe en tu cuaderno esa relación como una fracción: 7 sobre 21. Esto nos va a servir de base para comparar con la cantidad nueva que no conocemos todavía." Cada paso debe tener este nivel de detalle, NUNCA una frase corta tipo comando. "ejercicio.opciones": al menos 3, una correcta, 2+ incorrectas con errores típicos, cada explicacion también amplia y cálida. Si el objetivo es ESTRUCTURAL: "apoyoOperativo": null.`,        `35. "ejemplosVisuales" SOLO para asignaturas: artes, sociales, historia, ciencias. Para el resto: "ejemplosVisuales": [].`,
